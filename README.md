...
Deep Packet Inspection (DPI) engine for network traffic analysis and application-level filtering. Inspects encrypted HTTPS connections by extracting SNI, classifies apps (YouTube, Facebook, etc.), and enforces blocking rules. Includes single-threaded and multi-threaded implementations with thread-safe queues.

# 🚀 DPI Engine - Deep Packet Inspection System

> **Deep Packet Inspection (DPI) engine for network traffic analysis, application classification, and security-based filtering. Inspect encrypted HTTPS connections by extracting SNI, classify applications, and enforce blocking rules with multi-threaded architecture.**

![C++](https://img.shields.io/badge/C%2B%2B-17-00D4FF?style=flat-square&logo=cplusplus&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-A78BFA?style=flat-square)
![Status](https://img.shields.io/badge/Status-Production%20Ready-10B981?style=flat-square)
![Threads](https://img.shields.io/badge/Multi--Threaded-Yes-F97316?style=flat-square)
...
> **Key Insight:** Even though HTTPS is encrypted, the domain name is visible in the first packet!
...
**Key Insight:** Even HTTPS traffic leaks the destination domain in the TLS handshake, allowing network operators to identify and control application usage.
